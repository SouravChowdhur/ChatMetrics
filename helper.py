...
def create_wordcloud(selected_user, df):
    if selected_user != '🌍 Overall':
        df = df[df['user'] == selected_user]
    wc = WordCloud(width=500, height=500, max_words=50, max_font_size=80, min_font_size= 10, colormap="plasma",
        contour_color="steelblue",background_color='orange')
